...
|---|---|---|---|---|---|---|
| F-01 | 2,3 | O | Producto visible con descripción, precio y unidades disponibles procedentes del inventario. | UI + respuesta API + registro persistido concordantes. | Frontend / Backend | Cumple; ver F-01 en auditoría |
| F-02 | 2 | O | Acción de pagar con tarjeta de crédito claramente disponible. | Prueba UI del botón y su transición. | Frontend | Cumple; ver F-02 en auditoría |
| F-03 | 2 | O | La acción abre un modal para los datos de tarjeta. | E2E de abrir/cerrar y captura de modal. | Frontend / QA | Cumple; ver F-03 en auditoría |
| F-04 | 2 | O | Validar datos de tarjeta antes de avanzar; solo datos ficticios con estructura válida. | Jest de campos/formato y E2E de errores. | Frontend / QA | Cumple; ver F-04 en auditoría |
| F-05 | 2 | B | Reconocer al menos VISA y MasterCard y mostrar el logo correspondiente. Es plus funcional sin puntos separados en rúbrica. | Casos válidos, inválidos y marca no reconocida; capturas. | Frontend | Cumple; ver F-05 en auditoría |
| F-06 | 2,3 | O | Obtener datos de cliente y entrega necesarios para completar el envío. | Contrato, validaciones UI/API y persistencia. | Frontend / Backend | Cumple; ver F-06 en auditoría |
...
| F-14 | 2,3 | O | Mostrar resultado final comprensible y retornar a producto con inventario actualizado. | E2E de éxito y fallo, sin éxito falso. | Frontend / QA | Cumple; ver F-14 en auditoría |
| F-15 | 3 | O | Mantener cinco etapas: producto -> datos de tarjeta/entrega -> resumen -> resultado -> producto. | E2E completo y mapa UI documentado. | Frontend / QA | Cumple; ver F-15 en auditoría |
| F-16 | 3,4 | O | Recuperar progreso tras refrescar sin perder el estado seguro del checkout. | E2E de refresh en datos, resumen, procesamiento y resultado; política de datos. | Frontend / Backend / QA | Cumple; ver F-16 en auditoría |

## Matriz técnica y de información

| ID | Página | Tipo | Directriz y aceptación | Evidencia necesaria | Responsable | Estado |
|---|---|---|---|---|---|---|
| T-01 | 3 | O | Definir arquitectura API, datos y estructura del código coherente. | ADR/arquitectura y estructura implementada. | Director / Backend | Cumple; ver T-01 en auditoría |
| T-02 | 3 | O | Diseñar solicitudes y respuestas por endpoint explícitamente. | OpenAPI o colección Postman alineada con API real. | Backend | Cumple; ver T-02 en auditoría |
| T-03 | 3 | O | Validaciones por endpoint contemplan situaciones reales, con errores claros. | Jest de límites/tipos/datos inexistentes y QA negativo. | Backend / QA | Cumple; ver T-03 en auditoría |
| T-04 | 2,3 | O | Usar métodos y códigos HTTP apropiados para solicitudes y errores. | Contrato + pruebas de endpoints GET/POST y respuestas. | Backend / QA | Cumple; ver T-04 en auditoría |
| T-05 | 3 | O | API maneja existencias. | Endpoints/dominio/persistencia y test. | Backend | Cumple; ver T-05 en auditoría |
| T-06 | 3 | O | API maneja transacciones. | Creación, consulta, estados persistidos y test. | Backend | Cumple; ver T-06 en auditoría |
| T-07 | 3 | O | API maneja clientes. | Modelo, validación, persistencia y test. | Backend | Cumple; ver T-07 en auditoría |
| T-08 | 3 | O | API maneja entregas. | Modelo, asociación y test. | Backend | Cumple; ver T-08 en auditoría |
| T-09 | 3 | O | Recursos API admiten diferentes tipos de petición según el negocio; no basta un único stub. | Inventario de rutas y QA funcional; no se exige CRUD artificial. | Backend / QA | Cumple; ver T-09 en auditoría |
| T-10 | 4 | O | SPA construida exclusivamente con ReactJS o VueJS; elección del equipo: React. | Manifiesto/build y navegación SPA. | Frontend | Cumple; ver T-10 en auditoría |
| T-11 | 4 | O | Usar Redux o Vuex conforme a Flux; elección del equipo: Redux Toolkit. | Store/actions/selectors, transiciones y Jest. | Frontend | Cumple; ver T-11 en auditoría |
| T-12 | 4 | O | Mantener datos de transacción seguros en estado o localStorage. | Inspección de persistencia, sin PAN/CVC/secretos; test de restauración. | Frontend / QA | Cumple; ver T-12 en auditoría |
| T-13 | 4 | O | API en JavaScript/TypeScript o Ruby con framework permitido; elección: NestJS + TypeScript. | Dependencias/build y proceso real. | Backend | Cumple; ver T-13 en auditoría |
| T-14 | 4 | O | Lógica de negocio fuera del controlador/routing. | Revisión de controladores delgados y casos de uso probados. | Backend / Director | Cumple; ver T-14 en auditoría |
| T-15 | 4,6 | R+B | Arquitectura hexagonal con puertos/adaptadores reales y dominio desacoplado. | Diagrama + dependencias + adapters sustituibles + test del caso de uso. | Backend / Director | Cumple; ver T-15 en auditoría |
| T-16 | 4,6 | R+B | ROP explícito para casos de uso y propagación de fallos sin continuar efectos incorrectos. | Result tipado/composición + pruebas de ramas exitosas y fallidas. | Backend / Director | Cumple; ver T-16 en auditoría |
| T-17 | 4 | O | Base de datos persistente de libre elección. | Reinicio y consulta de datos conservados, esquema/migraciones. | Backend | Cumple; ver T-17 en auditoría |
...
| D-08 | Equipo | P | Cargas, pending, errores y reintento visibles y honestos; prevenir doble envío accidental. | E2E con red lenta/fallo y test de transiciones. | Frontend / QA | Cumple; ver D-08 en auditoría |
...
| S-12 | Equipo | P | Solo aprobación verificada descuenta stock y crea entrega, como máximo una vez. | Tests de aprobado duplicado, declined, pending, timeout y error proveedor. | Backend / QA | Cumple; ver S-12 en auditoría |
| S-13 | Equipo | P | Recuperar pago pendiente tras refresh sin reintentar el cobro ciegamente. | E2E de cierre/refresh durante pago y reconciliación por identificador. | Backend / Frontend / QA | Cumple; ver S-13 en auditoría |
| S-14 | Equipo | P | Limitar exposición de datos de cliente y transacción; validar entradas y acceso. | Modelo de amenaza, respuestas sanitizadas y pruebas de acceso indebido. | Backend / QA | Cumple; ver S-14 en auditoría |

## Calidad, repositorio y entrega

| ID | Página | Tipo | Directriz y aceptación | Evidencia necesaria | Responsable | Estado |
|---|---|---|---|---|---|---|
| Q-01 | 4,6 | O | Tests unitarios frontend con Jest, cobertura mayor que 80%. | Comando reproducible, salida y coverage-summary/json/html del frontend. | Frontend / QA | Cumple; ver Q-01 en auditoría |
| Q-02 | 4,6 | O | Tests unitarios backend con Jest, cobertura mayor que 80%. | Comando reproducible, salida y coverage-summary/json/html del backend. | Backend / QA | Cumple; ver Q-02 en auditoría |
| Q-03 | 4 | O | Publicar resultados reales de cobertura de ambas aplicaciones en README. | Cifras coincidentes con artefactos y commit probado. | QA / Release | Cumple; ver Q-03 en auditoría |
| Q-04 | 6 | B | Código limpio, legible, responsabilidades claras y complejidad justificada. | Revisión independiente y ejecución de lint/typecheck/build. | Director / QA | Cumple; ver Q-04 en auditoría |
